...
abstract class TweetSet {
  ...
  def mostRetweetedAcc(currentBest: Tweet): Tweet
...
class Empty extends TweetSet {
  ...
  def mostRetweetedAcc(currentBest: Tweet) = currentBest
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweetedAcc(currentBest: Tweet) =
    left.mostRetweetedAcc(right.mostRetweetedAcc(if (elem.retweets > currentBest.retweets) elem else currentBest))
